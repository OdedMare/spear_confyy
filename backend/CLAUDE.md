...
- Runtime configuration intentionally mirrors locatoAi: env defaults, JSON overrides, write-only secrets, live client reconfiguration and model probing before save.
